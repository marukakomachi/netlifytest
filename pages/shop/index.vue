  ...
  <layout-wrapper>
    ...
    <div class="container w-full mx-auto pt-20 pb-20 px-6 md:px-0">
      <table class="table-auto w-full mb-10">
        <tbody>
          ...
          <tr>
            ...
            <td class="border px-4 py-2">神保町駅5番出口から徒歩1分</td>
          </tr>
        </tbody>
      </table>
      <div class="mb-10">
      ...
      <div class="mx-auto mb-10 text-center">
        <nuxt-link
          to="/"
          class="rounded-lg px-4 md:px-5 xl::px-4 py-3 md:py-4 xl:py-4 bg-white hover:bg-gray-200 md:text-lg xl:text-base text-gray-800 font-semibold leading-tight shadow-md"
        >
          トップへ戻る
        </nuxt-link>
      </div>
